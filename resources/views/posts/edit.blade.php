                        ...
                        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    id="title" type="text" placeholder="Enter Title" name="title" value="{{ old('title', $post->title) }}">
                                @error('title')
                            ...
                            <div class="mb-4">
                                ...
                                <textarea
                                    ...
                                    id="body" type="text" placeholder="Enter body" name="body">{{ old('body', $post->body) }}</textarea>
                                @error('body')
                                    <div class="text-sm text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
