...
<div class="flex mb-4">
    <div class="w-1/3">
        <h3 class="text-gray-700 text-3xl font-medium">Edit Permission</h3>
    </div>
    <div class="w-1/3">
                ...
                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            id="name" type="text" placeholder="Enter Permission Name" name="name" value="{{ old('name', $permission->name) }}">
                        @error('name')
